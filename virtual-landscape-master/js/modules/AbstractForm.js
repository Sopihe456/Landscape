class AbstractForm {
   ...
   */
  static buildForms() {
    const cx =  window.innerWidth/0.9 - 2500/2

    const aForm1 = new AbstractForm(cx,250, 70, 100, 20, 'gold', '', 2, true )
    const aForm2 = new AbstractForm(cx,250, 70, 100, 100, 'gold', '', 2, false )
    const forms = [aForm1,aForm2]
    return forms
  }
